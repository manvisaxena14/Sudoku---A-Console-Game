...
//         sudoku(int n, int missingDigit){
//             this->n = n;
//             this-> missingDigit=missingDigit;

//             double squareRooted = sqrt(n);
//             squareRoot=(int)squareRooted;
//             matrix= new int*[n];
...
//         void fillDiagonal(){
//             for(int i=0; i<n; i=i+squareRoot){

//                 fillBox(i, i);
//             }
//         }

//         bool unusedBox(int rowStart, int colStart, int number){
//             for(int i=0;i<squareRoot;i++){
//                 for(int j=0;j<squareRoot; j++){
//                     if(matrix[rowStart+i][colStart+j] == number)
//                         return false;
//                 }
//             }
